...
class AllIndiaVVMcaTerminalSpider(JuicerSpider):
    name = 'allindiavvmca_terminal'
    ...
    def parse(self, response):
        ...
        courses = []
        courses = textify(hdoc.select('//table[@width="360"]//tr[10]//text()')).replace("\r\n\t\t\t\t\t", "").replace("Courses", "")
        if courses:
            print "coursessssssss>>>>", courses
