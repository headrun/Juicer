...
class RSS_Discovery(JuicerSpider):
    ...
    output_file = '/home/headrun/venu/rss/china_rss_tb'
    ...
    def start_requests(self):
        ...
        cursor = conn.cursor()
        sql = "SELECT url,netloc FROM rss_sources2 WHERE is_crawled=0 limit 80"
        try:
            cursor.execute(sql)
            ...
            #try:
            #    query = "UPDATE rss_sources2 SET is_crawled = 2 WHERE url in %s"
            #    values = str((my_tuple))
