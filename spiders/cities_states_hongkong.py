...
class Wiki(JuicerSpider):
    name = 'cities_states_hongkong'
    start_urls = ['http://www.fallingrain.com/world/HK/']
    ...
    def parse_terminal(self, response):
        ...
        for i in cities:
            ...
            url = 'http://www.blogger.com/profile-find.g?t=l&loc0=HK&loc1=%s&loc2=%s' %(state,city)
            ...
            values = (country,state,city, url)
            get_page('blogger_urls_hk', url, data='Hongkong')
