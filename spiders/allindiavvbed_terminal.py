...
class AllIndiaVVBedTerminalSpider(JuicerSpider):
    name = 'allindiavvbed_terminal'
    ...
    def parse(self, response):
        ...
        college_type = textify(hdoc.select('//table[@width="360"]//tr[2]//text()')).replace("College Type", "").replace("Type", "") 
        if college_type:
