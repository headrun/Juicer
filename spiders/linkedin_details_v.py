...
class LinkedinDetails(JuicerSpider):
    ...
    def start_requests(self):
        ...
        cursor = conn.cursor()
        print "Came here 01"
        sql = "SELECT pub_id, profile_url FROM linkedin_urls_new WHERE category= '%s' AND is_crawled = 3 limit 10000" %(category)
        try:
            cursor.execute(sql)
    ...
    def parse(self, response):
        ...
        for hon_node in tab_honorawards_nodes:
            ...
            try:
                ...
                print "hon_received_date>>",hon_received_date
            except:
                hon_received_date = ''
